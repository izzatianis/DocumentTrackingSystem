                ...
                <div class="container-fluid" id="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Logs for Document ID <?php echo $doc_id?></h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                  ...
                                                  echo "<tr>";
                                                  echo "<form method='post' target='_blank' action='dummy.php'>";
                                                  echo "<td >" . $row['id'] . "</td>";
                                                  ...
                                                  echo"<td><a href='\DTS\pdf\\".$row['pdfname']."' target='_blank' class='btn btn-primary'>View</a></td>";
